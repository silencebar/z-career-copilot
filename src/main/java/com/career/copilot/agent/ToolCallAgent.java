...
import com.career.copilot.agent.model.AgentState;
import lombok.Data;
...
public class ToolCallAgent extends ReActAgent {
    ...
    public boolean think() {
        ...
        try {
            ...
            this.finalResponse = "处理时遇到了错误：" + e.getMessage();
            getMessageList().add(new AssistantMessage(this.finalResponse));
            return false;
        }
    }
